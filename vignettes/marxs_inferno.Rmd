...
made: "Here you must abandon every suspicion; here must all your cowardice die."
(1859 Preface, Marx, quoting Dante's Divine Comedy)

> Capital is dead labour, that, vampire-like, only lives by sucking living
labour, and lives the more, the more labour it sucks. (Capital Vol 1, Marx 1867)
...
In this analysis, I linked sentiments to individual words rather than looking at
the context in which the word was used. The graph below will, I think,
immediately make it evident what some of the issues with this approach were.
...
interpret that phrase as negative. More sophisticated algorithms than what I
used here could address this shortcoming.
...
currently (and recurrently) travelling. (Roberts, 2017)
